...
int main(){
        printf("------------------------------------------------------\n");
        printf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
        printf("    Testing the functionality of solving puzzles!\n");
        printf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
        printf("Initializing a new puzzle... \n");
	puzzle_t *test = puzzle_new();

        printf("Manually setting the puzzle to this: \n");
        printf("* * * * * * * * * * * \n* 1 6 0 0 0 3 0 0 0 *\n* 2 0 0 7 0 6 0 1 4 *\n* 0 4 5 0 8 1 0 0 7 *\n* 5 0 8 4 0 0 0 0 0 *\n* 0 0 4 3 0 8 9 0 0 *\n* 0 0 0 0 0 7 2 0 8 *\n* 8 0 0 6 3 0 1 9 0 *\n* 6 3 0 1 0 5 0 0 2 *\n* 0 0 0 8 0 0 0 3 6 *\n* * * * * * * * * * * \n");
	...
	puzzle_set(test, 8, 8, 6);
        ...
        printf("Finished setting all the cells to the intended values...\n");
        printf("Here's the puzzle we will solve!:\n");
	puzzle_write(test);
        printf("\n");
        printf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
        printf("Here's the solution for the original puzzle: \n");
        printf("* * * * * * * * * * * \n* 1 6 7 5 4 3 8 2 9 * \n* 2 8 3 7 9 6 5 1 4 * \n* 9 4 5 2 8 1 3 6 7 * \n* 5 9 8 4 1 2 6 7 3 * \n* 7 2 4 3 6 8 9 5 1 * \n* 3 1 6 9 5 7 2 4 8 * \n* 8 7 2 6 3 4 1 9 5 * \n* 6 3 9 1 7 5 4 8 2 * \n* 4 5 1 8 2 9 7 3 6 * \n* * * * * * * * * * * \n");

        printf("Here's the solution generated by our solver for the puzzle:\n");
        backtrack(test, 0, 0);
	puzzle_write(test);
        printf("\n");

        printf("Great! They are the same!\n");
